...
namespace Scraper
{
    class SilverStarVanceCreek
    {
        ...
        public static void Run()
        {
            ...
            /*string startSearchPage = GetMainSearchResultsPage3(urlCode, eventValidationValue);
            Console.WriteLine("Got start search page");
            string page1 = GetMainSearchResultsPage(urlCode, eventValidationValue);
            Console.WriteLine("Got first page");*/
            ...
            Console.WriteLine("Contains 231? " + page.Contains("231"));
